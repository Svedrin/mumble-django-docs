# -*- coding: utf-8 -*-
#
# Mumble-Django documentation build configuration file, created by
...
project = u'Mumble-Django'
copyright = u'2010, Michael "Svedrin" Ziegler'
...
htmlhelp_basename = 'Mumble-Djangodoc'
...
latex_documents = [
  ('index', 'Mumble-Django.tex', u'Mumble-Django Documentation',
   u'Michael "Svedrin" Ziegler', 'manual'),
]
